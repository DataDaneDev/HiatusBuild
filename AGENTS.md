...
- Never commit raw order-history or invoice exports containing order IDs, account-scoped URLs, addresses, payment data, or unrelated personal items. Track only sanitized build/truck fields needed for BOM evidence.
