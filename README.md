...
- Heater/interior state: the LF Bros diesel heater is the main unresolved systems install and must be laid out with the rear driver-side storage module before either is closed in. The EVIL ENERGY `10 gal` tank/feed/vent package is purchased; release still requires delivered-parts inventory, sealed floor turret, underbody obstruction/clearance survey around the truck fuel tank and vehicle lines, fully exterior exhaust/muffler, fuel restraint/containment, and exterior venting. Final wall/ceiling/furniture paneling waits behind heater, drain, and access-dependent commissioning.
