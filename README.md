...
## Current project posture — 2026-08-27
...
- Heater/interior state: the LF Bros diesel heater is the main unresolved systems install and must be laid out with the rear driver-side storage module before either is closed in. Heat shield is supplemental; release still requires the sealed metal floor turret, an underbody obstruction/clearance survey around the truck fuel tank and vehicle lines, a fully exterior exhaust/muffler path, and exterior or sealed/externally vented diesel containment. Final wall/ceiling/furniture paneling waits behind heater, drain, and access-dependent commissioning.
- Counter/water state: a mid-September walnut-routing appointment is planned; bring the actual sink and soap dispenser for routing. Prove the bowl, drain body, faucet/soap hardware, support rails, and drain slope over the water tank before final cuts. Graywater remains mockup-gated; start by testing a vented, positively retained, normally closed removable vessel around `2.5 gal` rather than default open dumping.
