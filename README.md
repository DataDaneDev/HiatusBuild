...
- Current focus: finish Battery 2 absorption and Battery 3 charging/rested-voltage matching, parallel the `3x 48V` bank only at `<=0.1V` spread, rough in the office/Galley AC and DC branches while access is open, then build the plywood Galley counter and sink/faucet interfaces. Positive battery/cooler road restraint remains required before travel.
