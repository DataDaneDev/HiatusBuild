...
## Current BOM snapshot (2026-02-11)
- Estimated total from `bom/bom_estimated_items.csv`: `$46,703.64`
...
- Estimated line items exported: `102`
- Budget options exported: `24`
- Misc items exported: `15`

## AI-friendly exports
- `bom/bom_estimated_items.csv`: normalized estimated BOM rows from `D2:D103`
