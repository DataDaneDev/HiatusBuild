...
- [STARLINK_SOLAR_MOVING_UMBILICAL](plans/STARLINK_SOLAR_MOVING_UMBILICAL.md): current removable twin-coil Starlink/PV moving-roof architecture, purchasable-part shortlist, connector/tooling notes, measurement gates, and acceptance tests.
