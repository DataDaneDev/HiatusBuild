...
- The LF Bros heater and rear storage module are one dependency package. The EVIL ENERGY `10 gal` diesel tank/feed/vent package is purchased, but do not install the module or drill the heater turret until delivered-parts inventory, the complete underside exhaust/intake/fuel route, truck fuel tank/vehicle-line clearances, tank restraint, and compliant exterior or sealed/vented fuel containment are proven.
