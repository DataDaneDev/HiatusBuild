...
## Planning assumptions (as-of 2026-08-30)
...
- The LF Bros heater and rear storage module are one dependency package. The EVIL ENERGY `10 gal` diesel tank/feed/vent package and CaLeQi `60 mm / 2.37 in` stainless floor turret are purchased, but do not install the module or cut the nominal `125 mm` turret opening until the heater/gasket dry-fit, actual skirt/weld measurement, complete underside exhaust/intake/fuel route, skirt projection, truck fuel tank/vehicle-line/crossmember clearances, tank restraint, and compliant exterior or sealed/vented fuel containment are proven.
- Black-walnut sink/counter/desk routing is planned for mid-September. The never-fueled LF Bros `10 L` tank is selected as the removable graywater cassette; bring the actual sink and soap dispenser and prove support, actual drain/waterless-trap interfaces, `3/4-1 in` continuous fall, top tank inlet/vent, retention/removal, and low dump valve before cutting.
- Current dependency order is switch/service safety -> DC/AC branch closeout -> solar weather-window/cord proof -> heater/storage/tank dry layout -> mid-September walnut/sink routing -> `10 L` graywater mockup -> alternator `F-04`/sensor/WS500 commissioning -> storage/real-chair/desk mockup -> appliance/bench/monitor travel restraint -> final skins -> shakedown.
...
- **Heater/storage task:** inventory and dry-fit the purchased `10 gal` diesel tank/feed/vent package with the heater, sealed turret, underbody exhaust/intake/fuel route, fuel containment, pump, and rear storage module. Heat shield is supplemental; no drilling before the complete truck fuel tank/vehicle-line/undercoating/combustible survey and approximately `86 lb` full-tank restraint pass.
- **Walnut/water task:** bring the real sink and soap dispenser to the mid-September appointment. Prove bowl/drain/faucet/soap/support/tank/service geometry and continuous slope into the selected never-fueled LF Bros `10 L` gray tank; reserve the on-hand `1/2 in` clear hose for the normally closed dump leg, not the sink drain.
