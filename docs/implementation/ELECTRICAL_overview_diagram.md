...
| `C-27` | Purchased Renogy `4S` string + two-polarity transition box + continuous front-gap retractile + premium gland + stationary `12/2` + two-pole disconnect | MPPT PV input | No `F-09` presently planned | `9.50A Isc` STC / `14.8A` conservative conductor screen | Preferred `12 AWG x 2` after route/derating proof | Full route pending; `20 ft` one-way screen | `0.94%` at `9.5A / 78V` for `12 AWG` | Rows `31`, `106`, `121` | HOLD received labels/connectors, measured `~3-7 ft` endpoint span, tangent/transition-box/gland/splice geometry, rated extension reserve, `>=150VDC` and coiled-ampacity proof, articulation/full-stroke mockup, and hot restart/tracking commissioning |
