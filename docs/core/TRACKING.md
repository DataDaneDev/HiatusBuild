...
- Context: The owner rejected permanent Melnor `2MQC` faucet adapters as visually bulky, vulnerable to road damage, and operationally self-defeating because the Sea-Dog threaded cap required screwing each adapter on/off at every camp. The straight-through Sea-Dog and male `2MQC` also provide no automatic shutoff, making the interior BLUE ball valve part of every disconnect routine. The desired exterior remains two small discrete nubs with no hatch, box, or large service fixture.
...
- Impact (1-5): 4
- Likelihood (1-5): 3
- Mitigation: Validate each complete inside/outside route before cutting. For hot water, prove the rear-box cylinder restraint/vents, exterior HOTTAP quick-plate backing/cover, single BLUE/RED camper plate, supplied-hose reach, port protection, and operating clearances; no propane passthrough enters the camper.
...
- Propane hot-water direction and rear-box package are locked; physical geometry remains open. Dry-fit the Flame King `YSN10LB-ALM` in the reported `19.5 in` shelf opening and prove valve/QCC1 access, rigid foot capture, rated body restraint, thin EPDM anti-chafe pads, permanent low/high vents, and no blocked drain path. Direct-mount the Joolca vehicle quick plate to structural backing on the exterior box side, fit its mounted cover, and prove operating clearances, exhaust direction, regulator/service-hatch sweep, supplied `1 m`/`4 m` hose reach, faucet hot-only flow above `0.6 GPM`, and complete freeze draining.
...
- Prove the selected HOTTAP vehicle quick plate/backing and mounted cover, `10 lb` aluminum cylinder cradle/strap/pad package, fixed low/high box vents, regulator/service-hatch sweep, and full operating clearances with a physical box mockup.
- Lock the two-port BLUE/RED QD3 geometry only after one `QD3-FT10-P` / `QD3-MTN14` prototype proves panel/backer thickness, locknut and backside-hose clearance, actual Joolca adapter fit, auto-shutoff, hot flow, drainability, road-cap fit, and the measured approximately `19 in` hose reach. No large hatch or service box is in scope.
