...
- Result: select HOTTAP V2 Essentials and one `5 lb` QCC1 cylinder. Permanent camper plumbing is `accumulator -> 1/2 in tee`; branch to faucet cold, straight to BLUE valve/QD; RED QD/valve to insulated faucet hot. Use shower hose or faucet-return hose one at a time. Heater stores in the box but deploys outside it on feet/stand or a locked outboard arm that proves Joolca's full clearance envelope. The filled cylinder does not default to the rear box for travel: prove an accepted upright open-air restraint forward of the camper's rear plane or another approved open cargo location, then deploy the bottle to stable ground. No separate regulator, tank gauge, exterior selector, manifold, bypass, or alternate heater branch.
- Follow-up: measure the thin service plate/backer and hose length; verify FORIOUS inlet thread; source exact NSF CPC HFC35 `86600` panel bodies, `83100` inserts, and `HFC312L` dust plugs; mock the HOTTAP feet/stand or outboard arm against `39 in` top, `23.6 in` rear, and `19.7 in` front/side clearances; identify and obtain acceptance for the cylinder travel restraint; gauge-test pump/accumulator behavior; pressure/leak/ignition-test shower and sink modes at intended elevation; drain-test before drilling the final wall opening.
...
- Propane hot-water direction is locked; installation geometry remains open. Measure the bumper-box storage envelope and rear-wall-to-heater hose length; prove a feet/stand or positively locked outboard-arm deployment against Joolca's `39 in` top, `23.6 in` rear, and `19.7 in` front/side clearance envelope. Identify an accepted upright, valve-closed cylinder travel restraint forward of the camper's rear plane or another approved open cargo location; the rear box is not the default filled-cylinder travel location. Gauge-test SHURflo/accumulator behavior, test faucet hot-only flow above `0.6 GPM`, and prove both removable hoses and the heater drain completely for freezing conditions.
