...
- Propane hot-water direction and rear-box package are locked; physical fit-up remains open. Receive and dry-fit the complete purchased setup together: HOTTAP/bracket/cover, Flame King cylinder, CALPOSE gauge, Safoner hatch, AWW stone mat, and bracket/strap pack. Confirm cylinder fit, mounting, ventilation, hatch/mat placement, hose routing, leak-free LP connections, and HOTTAP operating clearance. Prototype one complete direct-profile camper-water port with the real HOTTAP hose before buying the second or drilling; retain QD3 only as fallback.
