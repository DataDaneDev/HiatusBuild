...
- Orion `48V` input protection is locked as: use a Lynx `48V+` bus tap into standalone `F-06`; run existing `30A 58V` MIDI for build/bench/interim use on the short `6 AWG` branch; purchased `3x` Mouser `576-166.7000.5202` Littelfuse FKS/ATO fuses (`20A`, `80VDC`) are correct. Correction: purchased `3x` `576-178.6150.0001` parts are empty housings, not install-ready holders. Final install requires `1x` complete `178.6152.2501` looped-wire holder and `2x` purpose-built `6 AWG -> 14-16 AWG` adhesive-lined reducer butt splices (Ancor `309106` class), with the two remaining correct fuses retained as spares. Lynx Slot 4/`F-05` remains open/blank and is not Orion protection.
