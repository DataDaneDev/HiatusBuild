...
- Lock the single camper BLUE/RED service-plate geometry and Sea-Dog `513120-1` / Melnor `2MQC` purchase after measuring camper wall/backer thickness, backside clearance, supplied-hose reach, port-cover/hatch geometry, and actual pump dead-head pressure.
