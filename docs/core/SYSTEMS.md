...
- Interior layout and wet-spine draft owner: [INTERIOR_furniture_layout_and_galley](../implementation/INTERIOR_furniture_layout_and_galley.md). Current direction is cold-water-first with a passenger-side lofted fridge/wet-spine exoskeleton: Iceco/fridge raised about `16 in`, pump/accumulator/service board below the fridge next to the wheel-well tank, rear shower/fill/vent service access, graywater cassette, and capped future hot-water stubs.
...
- Hot-water decision posture (`2026-07-24`): hydronic/marine-calorifier, exterior-vented RV propane, and electric tankless are no longer lead candidates. The live storage-heater shortlist is A.O. Smith E6-6C15SV (`6 gal`, `15.25H x 14.25 in dia`, about `$319`) as the preferred lowboy; Camplux ME60 (`6 gal`, about `21H installed x 15.75W x 15.5D`, Amazon `$229.99`) only if the measured cubby is wider than reported; Camplux ME40B (`4 gal`, `14.5H x 14.5W x 12.9D`, Amazon `$188.99`) as the short-body value fallback; Bosch ES4 (`4 gal`, `13.75H x 13.75W x 13.5D`, Amazon `$259`) when the smaller body makes the fit; and ThermoMate ES400B (`4 gal`, `24.3H x 12.6W x 12.4D including valve`, Amazon `$161.49`) only if the long cubby axis is vertical. Flame King YSNAZ132 remains temporary outdoor-shower-only under its manual.
