...
- Rear propane package: the `2026-07-26` purchase includes the Flame King `YSN10LB-ALM` cylinder, CALPOSE gauge, Safoner hatch, AWW stone mat, and bracket/strap pack. These are all owner-selected parts of the propane setup. Dry-fit the complete package in the rear box, keep the cylinder upright and secure, use camper-appropriate fasteners, preserve low/high ventilation, and leak-test the assembled gas connections.
...
- Use the Safoner hatch and AWW stone mat as part of the rear-box propane fit-up; confirm their exact placement with the complete package in hand.
- The planned rear-box LP package includes the cylinder, CALPOSE gauge, supplied QCC1 regulator/hose, and deployed HOTTAP. Keep the gas connections outdoors and leak-test them before operation.
